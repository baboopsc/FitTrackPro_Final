...
__decorate([
    (0, typeorm_1.ManyToOne)(() => workout_entity_1.Workout, (w) => w.workoutExercises, { onDelete: 'CASCADE' }),
    __metadata("design:type", workout_entity_1.Workout)
], WorkoutExercise.prototype, "workout", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => exercise_entity_1.Exercise, (e) => e.workoutExercises, { onDelete: 'CASCADE' }),
...
exports.WorkoutExercise = WorkoutExercise = __decorate([
    (0, typeorm_1.Entity)('workout_exercise_details')
], WorkoutExercise);
