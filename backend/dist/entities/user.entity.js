...
__decorate([
    (0, typeorm_1.OneToMany)(() => workout_entity_1.Workout, (workout) => workout.trainer),
    __metadata("design:type", Array)
], User.prototype, "createdWorkouts", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => nutrition_plan_entity_1.NutritionPlan, { nullable: true, eager: true }),
    (0, typeorm_1.JoinColumn)({ name: 'activeNutritionPlanId' }),
    __metadata("design:type", nutrition_plan_entity_1.NutritionPlan)
], User.prototype, "activeNutritionPlan", void 0);
