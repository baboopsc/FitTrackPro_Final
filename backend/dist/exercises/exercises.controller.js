...
let ExercisesController = class ExercisesController {
    ...
    create(dto) { return this.exercisesService.create(dto); }
    remove(id) { return this.exercisesService.remove(+id); }
    update(id, dto) { return this.exercisesService.update(+id, dto); }
};
